        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl">
                <div class=" text-gray-900 dark:text-gray-100">
                    <nav class="flex border-b  dark:bg-gray-800 dark:border-gray-700 mt-4 bg-white rounded-xl">
                    ...
                    <form action="{{ route('admin.categorie.update',$id )}}" method="POST" class="px-8 py-4">
                        @csrf
                        ...
                        <div class="tab-content" id="general">
                            <div class="grid col-span-2 row-span-3">
                                <div class="form-group m-4 flex flex-col col-start-1">
                                    ...
                                    <input type="text" name="name" class="form-control bg-white dark:bg-gray-800 rounded-xl" value="{{$id->name}}" readonly>
                                </div>
                                <div class="form-group m-4 flex flex-col">
                                    <label for="cpu"><i class="ri-quote-text"></i> Description</label>
                                    <input type="text" name="description" class="form-control bg-white dark:bg-gray-800 rounded-xl" value="{{$id->description}}">
                                </div>
                                <div class="form-group m-4 flex flex-col">
                                    <label for="storage"><i class="ri-image-line"></i> Image</label>
                                    <input type="text" name="image" class="form-control bg-white dark:bg-gray-800 rounded-xl" value="{{$id->image}}">
                                </div>
                                <div class="form-group m-4 flex flex-col col-start-2">
                                    <label for="extension"><i class="ri-puzzle-line"></i> Extension</label>
                                    <input value="{{$id->extension}}" id="extension" name="extension" class="form-control bg-white dark:bg-gray-800 rounded-xl" readonly>
                                </div>

                                <div class="form-group m-4 flex flex-col">
                                    <label for="maxbyuser"><i class="ri-user-2-line"></i> Max by user</label>
                                    <input type="number" name="maxbyuser" class="form-control bg-white dark:bg-gray-800 rounded-xl" value="{{$id->maxbyuser}}">
                                </div>
                                <div class="m-4 flex flex-col">
                                    <label for="stock"><i class="ri-instance-line"></i> Stock</label>
                                    <input type="number" name="stock" class="form-control bg-white dark:bg-gray-800 rounded-xl" min="-1" step="1" value="{{$id->stock}}">
                                </div>
                            </div>
                        </div>
            ...
            function updateFields() {
                ...
                for (const [key, field] of Object.entries(fields)) {
                    if (!field.information) {
                        ...
                        input.className = "form-control bg-white dark:bg-gray-800 rounded-xl";

                        const div = document.createElement("div");
                        div.className = "form-group m-4 flex bg-white dark:bg-gray-800 flex-col";
                        ...
                        if (field.type === "number") {
                            ...
                            maxDiv.querySelector('input').value = max[key];
                            ...
                            prixDiv.querySelector('input').value = prix[key];
