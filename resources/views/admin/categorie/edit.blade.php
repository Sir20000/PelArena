<x-app-layout>
                        ...
                        <div class="tab-content" id="general">
                            <div class="grid col-span-2 row-span-3">
                                <div class="form-group m-4 flex flex-col col-start-1">
                                    ...
                                    <input type="text" name="name" class="form-control rounded-xl" value="{{$id->name}}" readonly>
                                </div>
                                <div class="form-group m-4 flex flex-col">
                                    <label for="cpu"><i class="ri-quote-text"></i> Description</label>
                                    <input type="text" name="description" class="form-control rounded-xl" value="{{$id->description}}">
                                </div>
                                <div class="form-group m-4 flex flex-col">
                                    <label for="storage"><i class="ri-image-line"></i> Image</label>
                                    <input type="text" name="image" class="form-control rounded-xl" value="{{$id->image}}">
                                </div>
                                <div class="form-group m-4 flex flex-col col-start-2">
                                    <label for="extension"><i class="ri-puzzle-line"></i> Extension</label>
                                    <input value="{{$id->extension}}" id="extension" name="extension" class="form-control rounded-xl" readonly>
                                </div>

                                <div class="form-group m-4 flex flex-col">
                                    <label for="maxbyuser"><i class="ri-user-2-line"></i> Max by user</label>
                                    <input type="number" name="maxbyuser" class="form-control rounded-xl" value="{{$id->maxbyuser}}">
                                </div>
                                <div class="m-4 flex flex-col">
                                    <label for="stock"><i class="ri-instance-line"></i> Stock</label>
                                    <input type="number" name="stock" class="form-control rounded-xl" min="-1" step="1" value="{{$id->stock}}">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        const prix = @json($fields["prix"]);
        const max = @json($fields["max"]);
