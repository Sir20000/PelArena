<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @endif
            <nav class="flex border-b dark:border-gray-700 mt-4 bg-white dark:bg-gray-800 rounded-xl">
                ...
                <button class="tab-link px-4 py-2 text-gray-600 dark:text-gray-300 focus:outline-none" data-tab="ticket"><i class="ri-coupon-line"></i> Tickets</button>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl  tab-content" id="ticket">
            <div class="p-6 text-gray-900 dark:text-gray-100 space-y-4">

                <div class="form-group">
                    <label for="webhook_ticket" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Icon</label>

                    <input type="box" name="webhook_ticket" id="webhook_ticket" value="{{$settings['webhook_ticket']}}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-indigo-500" required>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Alert quand un ticket s'ouvre.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // Met à jour l'heure immédiatement et ensuite chaque seconde
        afficherHeure();
