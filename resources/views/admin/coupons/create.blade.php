                    ...
                    <form action="{{ route('admin.coupons.store') }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group flex">
                                <input type="text" id="name" name="name" class="form-control rounded-lg mt-1 w-full bg-gray-800 text-white border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" id="reduction" name="reduction" class="form-control rounded-lg mt-1 w-full bg-gray-800 text-white border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" step="0.01">
                        </div>
                        <div class="form-group mb-4">
                            <label for="expire_time" class="block text-sm font-medium text-gray-300">Date d'expiration</label>
                            <input type="datetime-local" id="expire_time" name="expire_time" value="{{ old('expire_time') }}" class="form-control rounded-lg mt-1 w-full bg-gray-800 text-white border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                        </div>
                        <div class="form-group mb-4">
