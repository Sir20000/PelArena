                        ...
                        <div class="item1">
                            <form action="{{ route('admin.users.index') }}" method="GET" class="">
                                <div class="input-group px-4 py-2">
                                    <input type="text" name="search" class="bg-gray-700 rounded-xl w-96" placeholder="Rechercher un user" value="{{ request('search') }}">
                    ...
                    <div class="space-y-4 mt-6">
                        ...
                        <div class="bg-white dark:bg-gray-700 p-4 mx-auto rounded-xl shadow-md flex items-center justify-between dark:text-white text-black relative" style="max-width: 1180px;">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-300 rounded-xl inline-block px-2 py-1">Email : {{ $p->email }}</p>
                            ...
                            <div class="flex items-center space-x-2 ">
                                ...
                                <form action="{{ route('admin.users.destroy', $p) }}" method="GET" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce coupon ?');">
                                    @csrf
