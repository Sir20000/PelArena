<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl bg-gradient-to-r from-blue-600 via-green-400 to-purple-500 bg-clip-text text-transparent  leading-tight flex justify-between items-center">
            {{ __('Servers') }}
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight flex justify-between items-center">
                            <div class="item1 hidden md:block">
                                <form action="{{ route('client.servers.index') }}" method="GET" class="">
                                    <div class="input-group px-2 py-2 flex items-center">
                                        ...
                                        <button type="submit" class=" bg-gray-400 dark:bg-gray-700 dark:text-white w-10 h-11 rounded-xl ml-2"><i class="ri-search-2-line "></i></button>
                                    </div>
                                </form>
                            </div>
                            <div class="item2">
