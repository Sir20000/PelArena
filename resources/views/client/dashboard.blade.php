<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-6">
            <div class="bg-white dark:bg-gray-800 border-2 dark:border-gray-800 overflow-hidden shadow-sm sm:rounded-xl py-4 xl:py-0">
                <div class="lg:p-6 text-gray-900 dark:text-gray-100  flex xl:flex-row flex-col gap-4">
                    <div class="flex  items-center dark:bg-gray-700 dark:text-white rounded-xl p-4 xl:w-48 w-full border-2 hover:translate-y-1 dark:border-gray-800 shadow-md  transition-all duration-300">
                    ...
                    <div class="flex items-center dark:bg-gray-700 dark:text-white rounded-xl p-4 xl:w-48 w-full border-2 hover:translate-y-1 dark:border-gray-800 dark:border-gray-800shadow-md  transition-all duration-300">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 max-w-7xl mx-auto sm:px-8 lg:px-6">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl border-2 dark:border-gray-800">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form action="{{ route('credit.paypal') }}" method="POST" class="">
                    <div class=" space-y-4">
                        ...
                        <button type="submit" class="w-full px-4 py-2 dark:bg-gray-700 hover:translate-y-1 active:translate-y-1.5 bg-gray-200 text-black border border-transparent rounded-md font-semibold dark:text-white  uppercase tracking-widest hover:bg-gray-300 dark:hover:bg-gray-600 focus:ring-2 focus:ring-indigo-100 transition ease-in-out duration-150">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl border-2 dark:border-gray-800">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="space-y-4">
                    ...
                    <button type="button" onclick="copyAffiliateLink()" class="w-full hover:translate-y-1 active:translate-y-1.5 px-4 py-2 bg-gray-200 dark:bg-gray-700 border border-transparent rounded-md font-semibold dark:text-white uppercase tracking-widest hover:bg-gray-300  dark:hover:bg-gray-600 focus:ring-2 focus:ring-indigo-500 transition ease-in-out duration-150">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-xl border-2 dark:border-gray-800">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="space-y-4">
                    ...
                    <button type="button" onclick="window.location.href='{{ route('client.servers.orders') }}'" class="w-full hover:translate-y-1 active:translate-y-1.5 px-4 py-2 bg-gray-200 dark:bg-gray-700 border border-transparent rounded-md font-semibold dark:text-white uppercase tracking-widest hover:bg-gray-300  dark:hover:bg-gray-600 focus:ring-2 focus:ring-indigo-500 transition ease-in-out duration-150">
                    ...
                    <button type="button" onclick="window.location.href='{{ route('tickets.create') }}'" class="w-full hover:translate-y-1 active:translate-y-1.5 px-4 py-2 bg-gray-200 dark:bg-gray-700 border border-transparent rounded-md font-semibold dark:text-white uppercase tracking-widest hover:bg-gray-300  dark:hover:bg-gray-600 focus:ring-2 focus:ring-indigo-500 transition ease-in-out duration-150">
                    ...
                    <button type="button" onclick="window.location.href='{{ route('profile.edit') }}'" class="w-full hover:translate-y-1 active:translate-y-1.5 px-4 py-2 bg-gray-200 dark:bg-gray-700 border border-transparent rounded-md font-semibold dark:text-white uppercase tracking-widest hover:bg-gray-300  dark:hover:bg-gray-600 focus:ring-2 focus:ring-indigo-500 transition ease-in-out duration-150">
...
<footer class="fixed bottom-0 left-0 w-full border-2 bg-gray-100 dark:bg-gray-800 dark:border-gray-800 dark:text-white ">
    <div class=" mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        <div class="flex space-x-8">
            ...
            <p><a href="{{ route('terms') }}" class="text-black dark:text-white hover:text-blue-500 transition-all">Terms and Conditions</a></p>
            <p><a href="{{ route('privacy') }}" class="text-black dark:text-white hover:text-blue-500 transition-all">Privacy Policy</a></p>
            <p><a href="{{ route('legal') }}" class="text-black dark:text-white hover:text-blue-500 transition-all">Legal Notice</a></p>
        </div>
