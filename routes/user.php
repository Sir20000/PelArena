...
Route::prefix('server')->middleware(['auth'])->group(function () {
    ...
    Route::get('/orders/{categorie}/{id}', [ServersController::class, 'product'])->name('client.servers.orders.categorie.product');
    ...
    Route::post('/order/create/{product}', [ServersController::class, 'createOrder'])->name('client.servers.order.create');
